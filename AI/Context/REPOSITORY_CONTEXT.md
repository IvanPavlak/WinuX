...
8. **Add a fork-only function (not yet upstreamed)** → Create `.ps1` under `Modules/Custom/<Module>/Functions/`, add its name to `Custom.psd1` `FunctionsToExport`, document it in `docs/custom/<module>.md`
