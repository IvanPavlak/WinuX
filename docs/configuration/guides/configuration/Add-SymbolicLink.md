...
Adds a symbolic link entry to the `SymbolicLinks` section of `Configuration.psd1`.
...
Reload-PowerShellProfile
$global:Configuration.PathTemplates
Get-SymbolicLinkEntries          # lists every configured link and whether it exists
```
...
- [`Add-SymbolicLink` in the Configuration module reference](../../../modules/configuration.md#add-symboliclink) - parameters, usage and behaviour
