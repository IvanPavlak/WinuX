...
Reload-PowerShellProfile
$global:Configuration.BootstrapConfig
Import-AppCsv -DataFileKey WinGetApps | Select-Object App, Machine -First 20
```
...
- [`Install-WingetApps` in the Application module reference](../../../modules/application.md#install-wingetapps) - parameters, usage and behaviour
