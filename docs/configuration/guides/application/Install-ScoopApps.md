...
Installs Scoop-managed apps from the WinuX CSV, filtered by the current machine type.
...
Import-AppCsv -DataFileKey ScoopApps | Select-Object App, Machine -First 20
```
...
- [`Install-ScoopApps` in the Application module reference](../../../modules/application.md#install-scoopapps) - parameters, usage and behaviour
...
- [`Install-ChocolateyApps`](Install-ChocolateyApps.md) - reads the same configuration
