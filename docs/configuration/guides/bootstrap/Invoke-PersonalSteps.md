...
Runs the fork-defined personal install steps from `BootstrapConfig.PersonalSteps`.
...
- [`Invoke-PersonalSteps` in the Bootstrap module reference](../../../modules/bootstrap.md#invoke-personalsteps) - parameters, usage and behaviour
