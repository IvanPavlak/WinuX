...
The ownership rule for `Close-Workspace`, in one place.
...
- [`Get-WorkspaceOpenDelta` in the Workflow module reference](../../../modules/workflow.md#get-workspaceopendelta) - parameters, usage and behaviour
