...
Updates the section headers (e.g., `# VIRTUAL DESKTOP 1 - Monitor: Primary - Layout: One`) within the `Layout` array of a layout file to match the actual configuration.
...
Reload-PowerShellProfile
$global:Configuration.ZoneNameMappings
$global:Configuration.ZoneNameMappings | ConvertTo-Json -Depth 3
```
...
- [`Update-LayoutSectionHeaders` in the Window module reference](../../../modules/window.md#update-layoutsectionheaders) - parameters, usage and behaviour
