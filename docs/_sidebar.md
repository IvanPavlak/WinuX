...
- **Getting Started**
    ...
    - [Subsequent Runs](/getting-started/subsequent-runs.md)

- **Configuration**
    - [Overview](/configuration/overview.md)
    - [Placeholder System](/configuration/placeholder-system.md)
    - [Machine Types](/configuration/machine-types.md)
    - [Repository Structure](/configuration/repository-structure.md)
    - [Reference](/configuration/configuration-reference.md)
    - **Guides**
        - [Add New Machine](/configuration/guides/add-new-machine.md)
        - [Add New Project](/configuration/guides/add-new-project.md)
        - [Add New Repository](/configuration/guides/add-new-repository.md)
        - [Add New Workspace](/configuration/guides/add-new-workspace.md)
        - [Add Symbolic Link](/configuration/guides/add-symbolic-link.md)
        - [Add Browser Group](/configuration/guides/add-browser-group.md)
        - [Configure Window Layout](/configuration/guides/configure-window-layout.md)
...
- **Project**
    - [README](https://github.com/IvanPavlak/WinuX#readme)
